...
# o	Part one includes 5 numbers. These five numbers are white ball numbers, which are drawn randomly
#     from 20 numbers from 1 to 20 inclusively - (1,2,3, 4, 5, … , 17,18,19, 20).
# o	Part two only has one number, the Powerball number, which is obtained randomly
